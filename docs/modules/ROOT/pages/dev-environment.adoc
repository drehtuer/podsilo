...
| ❌ *Never run*
| `.github/workflows/docs.yml` has never executed -- it cannot until it is on `main`. Its Kroki service pair and the `deploy-pages` half are reasoned about, not observed
|===
