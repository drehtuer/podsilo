...
| **Tier 1 — `./gradlew ktlintCheck detekt test`** | ✅ **Verified green** | 2026-08-22: **796 tests, 0 failures, 3 skipped**, exit 0. This row is the one place the count is kept — README quotes it, and nothing else should |
