...
/**
 * S2's app bar (`docs/UI.adoc` §5) — **the screen shipped without one at all**, alone among the eight.
 *
...
internal fun EpisodeListAppBar(
    ...
    // user meant to leave the mode (docs/UI.adoc §5).
    ...
    TopAppBar(
        ...
        actions = {
            ...
            // there and nowhere else (docs/UI.adoc §18).
            IconButton(
...
/**
 * Selection mode's bar: `n selected`, the two triage actions, *Select all*, and ✕ (`docs/UI.adoc` §5).
 *
 ...
 *
 * - **The count is a live region** (`docs/UI.adoc` §12.12): TalkBack announces `n selected` on every
...
/**
 * The confirmation selection-mode actions commit through (`docs/UI.adoc` §5, `docs/decisions/0014`).
 *
...
/**
 * *Download all (n)* — in the overflow rather than as a button, deliberately (`docs/UI.adoc` §5,
