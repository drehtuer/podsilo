...
/**
 * A failure as a row renders it (`docs/UI.adoc` §B1).
 *
 ...
 *   `docs/UI.adoc` §12.11 and `docs/architecture.adoc` §11 hang a real guarantee on: a lost folder grant must
 ...
 * condition (`docs/UI.adoc` §12.11). It is a queue-level state, not a per-episode one: existing
