...
/**
 * S1 — the podcast list, and the app's launcher screen (`docs/UI.adoc` §B2).
 *
 ...
 *   a download fails (`docs/UI.adoc` §4).
 ...
 *   (architecture §4).
 * @property undecidedCount `null` renders "–". **Never fetched is not zero** (`docs/UI.adoc` §12.5):
...
/**
 * The first-run steps, shown until the app can complete a download (`docs/UI.adoc` §4).
 *
...
/** Session-scoped, not persisted: the default makes the home screen a worklist (`docs/UI.adoc` §4). */
