...
/**
 * `SafDownloadTarget` writing through a **real** `DocumentsProvider` — what `architecture.adoc` §11
 * says can only be checked on a device, and what `dev-environment.adoc` listed as "never run".
 *
