...
/**
 * S7 — activity (`docs/UI.adoc` §10). *What is the app doing, and what is stuck?*
 *
...
private fun PausedBanner(
    ...
    Row(
        ...
        Row(
            ...
            // A condition the queue is in, not user input to fix (docs/UI.adoc §18).
...
private fun SyncRow(
    ...
    Row(
        ...
        // Disabled with the reason shown, rather than a button that times out (docs/UI.adoc §12.10).
        TextButton(
