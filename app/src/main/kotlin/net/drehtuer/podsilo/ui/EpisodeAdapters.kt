 ...
 * (`UI.adoc` §B0.2, `architecture.adoc` §2).
 */
@Singleton
 ...
 * means downloads will be named right — the point of `UI.adoc` §4's step 3.
 */
@Singleton
        ...
        override fun observe(): Flow<DownloadWork> =
            workScheduler.observeDownloadWork().map { infos ->
                ...
                infos.forEach { info ->
                    ...
                    // — which is exactly the distinction UI.adoc §B7 renders as
