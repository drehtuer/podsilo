 ...
 * value in the app that is not epoch millis (`architecture.adoc` §4, CLAUDE.md §11). The adapter
 ...
 *
 * `architecture.adoc` §5 exists to stop exactly this, by giving `EpochTime` two functions whose names
