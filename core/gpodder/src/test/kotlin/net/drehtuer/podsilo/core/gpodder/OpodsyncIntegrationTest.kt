 ...
 * turned `docs/decisions/0009-gpodder-api-wire-contract.adoc` from a contract *read* out of opodsync's
 * source into one actually exercised over the wire. See `docs/dev-environment.adoc` for how to run it.
 *
 ...
 * (`docs/decisions/0008-nextcloud-gpodder-discards-download-actions.adoc`), so a green run here says
