...
// Pure JVM, not com.android.library — resolves docs/architecture.adoc §12 open decision #3.
...
// no Robolectric and no Android test runner. See `docs/architecture.adoc` §2.
plugins {
