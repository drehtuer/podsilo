...
/**
 * The icon allow-list from `UI.adoc` §18, as code.
 *
 ...
 *
 * **What the artifact actually ships** (`UI.adoc` §18 assumed otherwise, and is amended):
...
object PodsiloIcons {
     ...
     * claim a decision the user did not make, and the affordances differ (`UI.adoc` §12.6).
     */
    ...
    // lockup instead (`UI.adoc` §C4.2), leaving the glyph with no call site — and this object is
