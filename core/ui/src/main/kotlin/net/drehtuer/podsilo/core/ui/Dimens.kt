...
// The spacing invariants from `UI.adoc` §17 and §19, in one place. They were duplicated in
...
/** The accessibility floor. A control below it is a bug, not a style choice (`UI.adoc` §12.12). */
