...
/**
 * **The notification small icon against the real alpha mask** (`docs/logo.md` §7's second open Tier 3
 * item, and §3).
 *
...
class NotificationIconConformanceTest {
    ...
    fun theFigureSurvivesBeingReducedToAlpha() {
        ...
        // exactly the failure `docs/logo.md` §1's minimum size and §3's 18-in-24 padding exist to
