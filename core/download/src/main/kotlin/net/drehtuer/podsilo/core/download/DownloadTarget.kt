 ...
 * chosen folder (`docs/architecture.adoc` §8/§11).
 *
 ...
 * project has never successfully booted one (`docs/dev-environment.adoc` §6). See
...
interface DownloadTarget {
     ...
     * (`docs/UI.adoc` §5). `null` means the warning is simply not shown: the estimate it feeds is
