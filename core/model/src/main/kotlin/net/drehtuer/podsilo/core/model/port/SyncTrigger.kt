 ...
 *
 * `architecture.adoc` §10/§12 (decision #4) settles the "who POSTs the episode action" question
 ...
 * `:core:model` is the one place every module can already reach (`architecture.adoc` §2).
 *
