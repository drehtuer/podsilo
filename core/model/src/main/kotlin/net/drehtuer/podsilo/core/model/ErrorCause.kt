 ...
 * later by reading the message text (`docs/UI_interface.md` §1).
 *
 * This exists because a screen has to make a decision that a sentence cannot support:
 * `docs/UI.md` §12.11 and `docs/decisions/0011` require that a row whose download failed because the
 ...
 * `docs/decisions/0001`: snapshot at write time what a later reader will need).
 */
