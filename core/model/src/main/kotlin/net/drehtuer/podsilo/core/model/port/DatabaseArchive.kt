 ...
 * Keystore-backed cipher (`docs/architecture.adoc` §2), not in the database, so it is not in the zip and
 ...
 * so `:core:model` stays free of `android.net.Uri` (`docs/architecture.adoc` §2).
 */
