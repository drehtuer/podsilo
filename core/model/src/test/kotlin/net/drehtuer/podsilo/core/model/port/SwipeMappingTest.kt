...
/**
 * The invariant under test is `docs/UI.adoc` §7's: the two directions never hold the same action, and
...
class SwipeMappingTest {
    ...
    fun `both directions may be disabled at once`() {
        ...
        // since every swipe has a visible equivalent in the overflow (docs/UI.adoc §1).
        val mapping =
            SwipeMapping()
