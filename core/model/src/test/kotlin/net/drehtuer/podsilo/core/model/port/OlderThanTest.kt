...
/**
 * `docs/decisions/0013`'s cutoff. Calendar arithmetic, not fixed day counts — this rule *writes*
...
class OlderThanTest {
    ...
    fun `the zone is the one passed in, not the runner's default`() {
        ...
        // zone is a parameter for the same reason :core:naming takes one (`docs/architecture.adoc` §11).
